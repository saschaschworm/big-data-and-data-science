...
model = RandomForestRegressor(**hyperparams)
    ...
    \begin{frame}{Development Exercise \arabic{devexercise}}
        ...
        \note{
            ...
            \small{\href{https://nbviewer.jupyter.org/github/saschaschworm/big-data-and-data-science/blob/master/notebooks/development-exercises/backorder-random-forest.ipynb}{\textsc{\textbf{$\rightarrow$ open notebook in nbviewer}}}}
